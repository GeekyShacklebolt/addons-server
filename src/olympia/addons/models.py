...
class AddonUser(
    caching.CachingMixin, OnChangeMixin, SaveUpdateMixin, models.Model
):
    addon = models.ForeignKey(Addon, on_delete=models.CASCADE)
    user = UserForeignKey()
