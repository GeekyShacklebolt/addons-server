...
def queue_counts(
    admin_reviewer, limited_reviewer, extension_reviews, theme_reviews
):
...
class AddonReviewerViewSet(GenericViewSet):
    ...
    def disable(self, request, **kwargs):
        ...
        self.log.info(
            'Addon "%s" status changed to: %s', addon.slug, amo.STATUS_DISABLED
        )
    ...
    def enable(self, request, **kwargs):
        ...
        self.log.info(
            'Addon "%s" status changed to: %s', addon.slug, amo.STATUS_PUBLIC
        )
