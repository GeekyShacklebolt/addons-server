...
discopane_items = {
    'default': [
        # 'Bokeh Beta' theme.
        DiscoItem(addon_id=42019, type=amo.ADDON_PERSONA),
        # Privacy Badger
        DiscoItem(
            addon_id=506646,
            heading=_(
                u'Stop sneaky trackers {start_sub_heading}'
                u'with {addon_name}{end_sub_heading}'
            ),
            description=string_concat(
                '<blockquote>',
                _(
                    u' Block invisible trackers and spying ads that follow you '
                    u'around the web.'
                ),
                '</blockquote>',
            ),
        ...
        DiscoItem(
            addon_id=850407,
            heading=_(
                u'Customize new tab pages {start_sub_heading}with '
                u'{addon_name} {end_sub_heading}'
            ),
            description=string_concat(
                '<blockquote>',
                _(
                    u'Enjoy a beautiful new page with customizable backgrounds, '
        ...
        # 'Foggy Dawn' theme
        DiscoItem(
            addon_id=553386, type=amo.ADDON_PERSONA, addon_name='Foggy Dawn'
        ),
        # To Google Translate
        DiscoItem(
            addon_id=445852,
            heading=_(
                u'Translate easily {start_sub_heading}'
                u'with {addon_name}{end_sub_heading}'
            ),
            description=string_concat(
                '<blockquote>',
                _(
                    u'Highlight any text, right-click, and translate '
                    u'instantly.'
                ),
                '</blockquote>',
            ),
        ...
        DiscoItem(
            addon_id=93451,
            heading=_(
                u'Search Images {start_sub_heading}with {addon_name}'
                u'{end_sub_heading}'
            ),
            description=string_concat(
                '<blockquote>',
        ...
        DiscoItem(addon_id=482976, type=amo.ADDON_PERSONA),
    ],
